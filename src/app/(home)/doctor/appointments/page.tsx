            ...
            <div className="grid bg-white grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl ">
              ...
              <div className="border-r border-[#DCDCDC] p-6 lg:col-span-2">
                 <div className="w-24 h-24 mb-3 md:w-20 md:h-20 rounded-full overflow-hidden bg-teal-500 flex-shrink-0">
                    ...
                    />
                  </div><div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                ...
                <div className="w-full flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="w-full lg:w-3/4 rounded-2xl overflow-hidden">
                    ...
                    {availabilityData.map((item, index) => (
                      <div
                        key={index}
                        className={`grid grid-cols-3 p-4 text-sm ${index % 2 === 0 ? "bg-white" : "bg-gray-50"} ${index === 0 ? "font-semibold text-gray-800" : ""}`}
                      >
                        <div>{item.day}</div>
                        <div>{item.start}</div>
                        <div>{item.end}</div>
                  ...
                  <div className="w-full lg:w-1/4 space-y-2 p-4 rounded-lg bg-[#F5F7F9]">
                        ...
                        <div className="relative">
                          ...
                          <span className="absolute right-[15px] top-[16px] -translate-y-1/2 w-4 h-4 rounded-lg text-white">
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <path d="M12.5 9V13L14.5 15" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                          </span>
                        </div>
                      </div>
                    ...
                    <button className="flex items-center shadow-md bg-white text-[#3D3D3D] hover:text-blue-800 hover:bg-blue-50 px-4 py-2 rounded-md w-full">
                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      {patients.map((patient) => (
                        <tr key={patient.id} className="hover:bg-gray-50">
                          ...
                          <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">
                            <span
                              className={`inline-flex rounded-full px-4 py-1 text-xs font-semibold leading-5 ${patient.status === "In Care"
